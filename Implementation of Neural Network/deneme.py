...
train_data_dir = 'E:\\TurkishSignLanguage\\Dataset\\Main2Dataset_224\\AugmentedTraining\\deneme'
# Define image size
image_size = (224, 224)
...
converter.experimental_new_converter = True  # Enable the new converter for more detailed logging
...
# model.save(os.path.join(destination_dir, 'MobileNet_ownDataset3_dropout.h5'))
