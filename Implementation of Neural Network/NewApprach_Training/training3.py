...
# Train the model
history = model.fit(train_generator, epochs=35, validation_data=validation_generator, callbacks=[early_stopping])


# First, save your Keras model to the Kaggle working directory
model_path = r'C:\Users\nilay\Desktop\Dataset\Main2Dataset_224\veriseti3_denemeler\deneme3_30epoch.keras'
